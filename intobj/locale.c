...
object _41get_text(object _MsgNum_18801, object _LocalQuals_18802, object _DBBase_18803)
{
    ...
    object _10309 = NOVALUE; // 18860 10309
// skipping _10308  name type: 0
    object _10307 = NOVALUE; // 18857 10307
// skipping _10306  name type: 0
    object _10305 = NOVALUE; // 18854 10305
    object _10304 = NOVALUE; // 18853 10304
    object _10303 = NOVALUE; // 18851 10303
// skipping _10302  name type: 0
    object _10301 = NOVALUE; // 18848 10301
    object _10300 = NOVALUE; // 18847 10300
    object _10299 = NOVALUE; // 18846 10299
...
// skipping _10294  name type: 0
    object _10293 = NOVALUE; // 18835 10293
    object _10292 = NOVALUE; // 18834 10292
    object _10291 = NOVALUE; // 18832 10291
// skipping _10290  name type: 0
// skipping _10289  name type: 0
// skipping _10288  name type: 0
// skipping _10286  name type: 0
// skipping _10285  name type: 0
    object _10284 = NOVALUE; // 18822 10284
// skipping _10283  name type: 0
    object _10281 = NOVALUE; // 18819 10281
    object _10279 = NOVALUE; // 18817 10279
// skipping _10278  name type: 0
    object _10277 = NOVALUE; // 18813 10277
    object _10276 = NOVALUE; // 18812 10276
    object _10275 = NOVALUE; // 18811 10275
    object _10274 = NOVALUE; // 18810 10274
    object _0, _1, _2;
    ...
    _10274 = _6string(_LocalQuals_18802);
...
L1: // addr: 45 pc: 44 sub: 18799 op: 159
    ...
    if (IS_SEQUENCE(_LocalQuals_18802)){
            _10279 = SEQ_PTR(_LocalQuals_18802)->length;
    }
    else {
        _10279 = 1;
    }
...
L2: // addr: 57 pc: 50 sub: 18799 op: 125
        ...
        _10281 = (object)*(((s1_ptr)_2)->base + _i_18816);
        // SubProg get_text pc: 63 op: CONCAT_N (157)
        {
            object concat_list[4];

            concat_list[0] = _10282;
            concat_list[1] = _10281;
            concat_list[2] = _10280;
        ...
        RefDS(_5);
        RefDS(_5);
        _10284 = _16locate_file(_dbname_18807, _5, _5);
        // SubProg get_text pc: 78 op: PROC (27)
        _db_res_18805 = _44db_select(_10284, 3);
        _10284 = NOVALUE;
        ...
        RefDS(_10287);
        _db_res_18805 = _44db_select_table(_10287);
...
L3: // addr: 136 pc: 131 sub: 18799 op: 54
    ...
    _10292 = IS_ATOM(_lMsgText_18806);
    ...
    Concat((object_ptr)&_10293, _DBBase_18803, _10282);
    // SubProg get_text pc: 150 op: PROC (27)
    RefDS(_5);
    RefDS(_5);
    _0 = _dbname_18807;
    _dbname_18807 = _16locate_file(_10293, _5, _5);
    DeRef(_0);
    _10293 = NOVALUE;
    ...
    if (IS_SEQUENCE(_LocalQuals_18802)){
            _10299 = SEQ_PTR(_LocalQuals_18802)->length;
    }
    else {
        _10299 = 1;
    }
...
LA: // addr: 201 pc: 194 sub: 18799 op: 125
        ...
        _2 = (object)SEQ_PTR(_LocalQuals_18802);
        _10300 = (object)*(((s1_ptr)_2)->base + _i_18845);
        // SubProg get_text pc: 207 op: RIGHT_BRACE_2 (85)
        Ref(_10300);
        _1 = NewS1(2);
        _2 = (object)((s1_ptr)_1)->base;
        ((intptr_t *)_2)[1] = _10300;
        ...
        RefDS(_44current_table_name_16090);
        _0 = _lMsgText_18806;
        _lMsgText_18806 = _44db_fetch_record(_10301, _44current_table_name_16090);
        DeRef(_0);
        _10301 = NOVALUE;
        ...
        _10303 = IS_SEQUENCE(_lMsgText_18806);
...
LB: // addr: 238 pc: 233 sub: 18799 op: 54
    ...
    _10304 = IS_ATOM(_lMsgText_18806);
    ...
    RefDS(_44current_table_name_16090);
    _0 = _lMsgText_18806;
    _lMsgText_18806 = _44db_fetch_record(_10305, _44current_table_name_16090);
    DeRef(_0);
    _10305 = NOVALUE;
...
LD: // addr: 260 pc: 259 sub: 18799 op: 159
    ...
    _10307 = IS_ATOM(_lMsgText_18806);
...
L7: // addr: 281 pc: 280 sub: 18799 op: 159
    ...
    _10309 = IS_ATOM(_lMsgText_18806);
