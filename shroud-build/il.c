...
L6: 
    ...
    /** il.e:361			shroud_only = TRUE*/
    _39shroud_only_16813 = _9TRUE_444;

    /** il.e:362			OpDefines &= { "EUB_SHROUD" }*/
    _1 = NewS1(1);
    _2 = (object)((s1_ptr)_1)->base;
    RefDS(_33256);
    ((intptr_t*)_2)[1] = _33256;
    _33257 = MAKE_SEQ(_1);
    Concat((object_ptr)&_39OpDefines_16888, _39OpDefines_16888, _33257);
    DeRefDS(_33257);
    _33257 = NOVALUE;
    ...
    _2 = (object)((s1_ptr)_1)->base;
    RefDS(_33259);
    ((intptr_t*)_2)[1] = _33259;
    _33260 = MAKE_SEQ(_1);
    Concat((object_ptr)&_39OpDefines_16888, _39OpDefines_16888, _33260);
    DeRefDS(_33260);
    _33260 = NOVALUE;
...
object _3base200(object _x_66867)
{
    object _digits_66868 = NOVALUE;
...
L1: 
        ...
        if (IS_ATOM_INT(_x_66867)) {
            _33262 = (_x_66867 % 200);
        }
        else {
            temp_d.dbl = (eudouble)200;
            _33262 = Dremainder(DBL_PTR(_x_66867), &temp_d);
        }
        Ref(_33262);
        Append(&_digits_66868, _digits_66868, _33262);
        DeRef(_33262);
        _33262 = NOVALUE;
        ...
        if (IS_ATOM_INT(_x_66867)) {
            if (200 > 0 && _x_66867 >= 0) {
                _x_66867 = _x_66867 / 200;
            }
            else {
                temp_dbl = EUFLOOR((eudouble)_x_66867 / (eudouble)200);
                if (_x_66867 != MININT)
                _x_66867 = (object)temp_dbl;
                else
                _x_66867 = NewDouble(temp_dbl);
            }
        }
        else {
            _2 = binary_op(DIVIDE, _x_66867, 200);
            _x_66867 = unary_op(FLOOR, _2);
            DeRef(_2);
        }
        DeRef(_0);
...
L2: 
    ...
    _33265 = binary_op(PLUS, _digits_66868, 32);
    DeRef(_x_66867);
    DeRefDS(_digits_66868);
    return _33265;
    ;
}


void _3store_checksum(object _backend_name_66877)
{
    object _c_66878 = NOVALUE;
    object _prev_c_66879 = NOVALUE;
    object _bound_file_66880 = NOVALUE;
    object _size_66881 = NOVALUE;
    object _checksum_66882 = NOVALUE;
    ...
    _bound_file_66880 = EOpen(_backend_name_66877, _33266, 0);

    /** il.e:391		if seek(bound_file, check_place+8) then*/
    _33268 = _3check_place_66864 + 8;
    if ((object)((uintptr_t)_33268 + (uintptr_t)HIGH_BITS) >= 0){
        _33268 = NewDouble((eudouble)_33268);
    }
    _33269 = _19seek(_bound_file_66880, _33268);
    _33268 = NOVALUE;
    if (_33269 == 0) {
        DeRef(_33269);
        _33269 = NOVALUE;
        ...
        if (!IS_ATOM_INT(_33269) && DBL_PTR(_33269)->dbl == 0.0){
            DeRef(_33269);
            _33269 = NOVALUE;
            goto L1; // [23] 38
        }
    ...
    RefDS(_21928);
    _33270 = _44GetMsgText(315, 1, _21928);
    _3fatal(_33270);
    _33270 = NOVALUE;
L1: 

    /** il.e:395		checksum = 11352 -- magic starting point*/
    DeRef(_checksum_66882);
    _checksum_66882 = 11352;
...
L2: 
    ...
    if (_bound_file_66880 != last_r_file_no) {
        last_r_file_ptr = which_file(_bound_file_66880, EF_READ);
        last_r_file_no = _bound_file_66880;
    }
    if (last_r_file_ptr == xstdin) {
        if (in_from_keyb) {
            _c_66878 = getc((FILE*)xstdin);
        }
        else{
            _c_66878 = getc(last_r_file_ptr);
        }
    }
    else{
        _c_66878 = getc(last_r_file_ptr);
...
L4: 
    ...
    /** il.e:405					checksum += c*/
    _0 = _checksum_66882;
    if (IS_ATOM_INT(_checksum_66882)) {
        _checksum_66882 = _checksum_66882 + _c_66878;
        if ((object)((uintptr_t)_checksum_66882 + (uintptr_t)HIGH_BITS) >= 0){
            _checksum_66882 = NewDouble((eudouble)_checksum_66882);
        }
    }
    else {
        _checksum_66882 = NewDouble(DBL_PTR(_checksum_66882)->dbl + (eudouble)_c_66878);
    }
    DeRef(_0);
    goto L6; // [98] 112
L5: 
    ...
    _33278 = _c_66878 + _c_66878;
    if ((object)((uintptr_t)_33278 + (uintptr_t)HIGH_BITS) >= 0){
        _33278 = NewDouble((eudouble)_33278);
    }
    _0 = _checksum_66882;
    if (IS_ATOM_INT(_checksum_66882) && IS_ATOM_INT(_33278)) {
        _checksum_66882 = _checksum_66882 + _33278;
        if ((object)((uintptr_t)_checksum_66882 + (uintptr_t)HIGH_BITS) >= 0){
            _checksum_66882 = NewDouble((eudouble)_checksum_66882);
        }
    }
        ...
        if (IS_ATOM_INT(_checksum_66882)) {
            _checksum_66882 = NewDouble((eudouble)_checksum_66882 + DBL_PTR(_33278)->dbl);
        }
        else {
            if (IS_ATOM_INT(_33278)) {
                _checksum_66882 = NewDouble(DBL_PTR(_checksum_66882)->dbl + (eudouble)_33278);
            }
            else
            _checksum_66882 = NewDouble(DBL_PTR(_checksum_66882)->dbl + DBL_PTR(_33278)->dbl);
        }
    }
    DeRef(_0);
    DeRef(_33278);
...
L6: 
    ...
    /** il.e:410			size += 1*/
    _0 = _size_66881;
    if (IS_ATOM_INT(_size_66881)) {
        _size_66881 = _size_66881 + 1;
        if (_size_66881 > MAXINT){
            _size_66881 = NewDouble((eudouble)_size_66881);
        }
    }
    else
    _size_66881 = binary_op(PLUS, 1, _size_66881);
    DeRef(_0);

    /** il.e:411			prev_c = c*/
    _prev_c_66879 = _c_66878;
...
L3: 
    ...
    _33281 = _19seek(_bound_file_66880, _3check_place_66864);
    if (_33281 == 0) {
        DeRef(_33281);
        _33281 = NOVALUE;
        goto L7; // [137] 152
        ...
        if (!IS_ATOM_INT(_33281) && DBL_PTR(_33281)->dbl == 0.0){
            DeRef(_33281);
            _33281 = NOVALUE;
            goto L7; // [137] 152
        }
    ...
    RefDS(_21928);
    _33282 = _44GetMsgText(316, 1, _21928);
    _3fatal(_33282);
    _33282 = NOVALUE;
L7: 
    ...
    Ref(_size_66881);
    _33283 = _3base200(_size_66881);
    EPuts(_bound_file_66880, _33283); // DJP 
    DeRef(_33283);
    _33283 = NOVALUE;
    ...
    _0 = _checksum_66882;
    if (IS_ATOM_INT(_checksum_66882)) {
        _checksum_66882 = (_checksum_66882 % 1000000000);
    }
    else {
        temp_d.dbl = (eudouble)1000000000;
        _checksum_66882 = Dremainder(DBL_PTR(_checksum_66882), &temp_d);
    }
    DeRef(_0);

    /** il.e:421		puts(bound_file, base200(checksum))*/
    Ref(_checksum_66882);
    _33286 = _3base200(_checksum_66882);
    EPuts(_bound_file_66880, _33286); // DJP 
    DeRef(_33286);
    _33286 = NOVALUE;

    /** il.e:422	end procedure*/
    DeRefDS(_backend_name_66877);
    DeRef(_size_66881);
    DeRef(_checksum_66882);
    return;
    ;
...
void _3OutputIL()
{
    object _out_66918 = NOVALUE;
    object _be_66919 = NOVALUE;
    object _m_66920 = NOVALUE;
    object _c_66921 = NOVALUE;
    object _ic_66922 = NOVALUE;
    object _size_66923 = NOVALUE;
    object _out_name_66924 = NOVALUE;
    object _last6_66925 = NOVALUE;
    object _backend_name_66926 = NOVALUE;
    object _source_dir_66927 = NOVALUE;
    object _eu_dir_66928 = NOVALUE;
    object _ondisk_name_66991 = NOVALUE;
    object _filename_67038 = NOVALUE;
    ...
    if (IS_SEQUENCE(_3user_out_66388)){
            _33287 = SEQ_PTR(_3user_out_66388)->length;
    }
    else {
        _33287 = 1;
    }
    ...
    DeRef(_out_name_66924);
    _out_name_66924 = _3user_out_66388;
    goto L2; // [20] 110
L1: 
    ...
    DeRef(_out_name_66924);
    _2 = (object)SEQ_PTR(_36known_files_15405);
    _out_name_66924 = (object)*(((s1_ptr)_2)->base + 1);
    Ref(_out_name_66924);

    /** il.e:435			m = length(out_name)*/
    if (IS_SEQUENCE(_out_name_66924)){
            _m_66920 = SEQ_PTR(_out_name_66924)->length;
    }
    else {
        _m_66920 = 1;
    }
...
L3: 
    ...
    _2 = (object)SEQ_PTR(_out_name_66924);
    _33291 = (object)*(((s1_ptr)_2)->base + _m_66920);
    if (binary_op_a(NOTEQ, _33291, 46)){
        _33291 = NOVALUE;
        goto L5; // [53] 62
    }
    _33291 = NOVALUE;
...
L4: 
    ...
    _33294 = _m_66920 - 1;
    rhs_slice_target = (object_ptr)&_out_name_66924;
    RHS_Slice(_out_name_66924, 1, _33294);
L6: 
    ...
    Concat((object_ptr)&_out_name_66924, _out_name_66924, _33296);
    goto L8; // [103] 109
L7: 
...
L2: 
    ...
    _out_66918 = EOpen(_out_name_66924, _33299, 0);
    ...
    _1 = NewS1(1);
    _2 = (object)((s1_ptr)_1)->base;
    RefDS(_out_name_66924);
    ((intptr_t*)_2)[1] = _out_name_66924;
    _33302 = MAKE_SEQ(_1);
    _33303 = _44GetMsgText(301, 1, _33302);
    _33302 = NOVALUE;
    _3fatal(_33303);
    _33303 = NOVALUE;
L9: 
    ...
    _33305 = IS_SEQUENCE(_3eub_path_66395);
    if (_33305 == 0)
    {
        _33305 = NOVALUE;
        goto LB; // [155] 177
    ...
    DeRef(_backend_name_66926);
    _backend_name_66926 = _3eub_path_66395;

    /** il.e:465				be = open( backend_name, "rb" )*/
    _be_66919 = EOpen(_backend_name_66926, _33306, 0);
    goto LC; // [174] 341
LB: 

    /** il.e:467				eu_dir = get_eudir()*/
    _0 = _eu_dir_66928;
    _eu_dir_66928 = _36get_eudir();
    DeRef(_0);

    /** il.e:469				source_dir = command_line()*/
    DeRef(_source_dir_66927);
    _source_dir_66927 = Command_Line();

    /** il.e:470				source_dir = source_dir[2]*/
    _0 = _source_dir_66927;
    _2 = (object)SEQ_PTR(_source_dir_66927);
    _source_dir_66927 = (object)*(((s1_ptr)_2)->base + 2);
    RefDS(_source_dir_66927);
    DeRefDS(_0);

    /** il.e:471				for j = length( source_dir ) to 1 by -1 do*/
    if (IS_SEQUENCE(_source_dir_66927)){
            _33311 = SEQ_PTR(_source_dir_66927)->length;
    }
    else {
        _33311 = 1;
    }
...
LD: 
        ...
        _2 = (object)SEQ_PTR(_source_dir_66927);
        _33312 = (object)*(((s1_ptr)_2)->base + _j_66970);
        if (binary_op_a(NOTEQ, _33312, 47)){
            _33312 = NOVALUE;
            goto LF; // [214] 232
        }
        _33312 = NOVALUE;
        ...
        rhs_slice_target = (object_ptr)&_source_dir_66927;
        RHS_Slice(_source_dir_66927, 1, _j_66970);
...
LF: 
        ...
        _33316 = _16current_dir();
        if (IS_SEQUENCE(_33316) && IS_ATOM(47)) {
            Append(&_source_dir_66927, _33316, 47);
        }
        else if (IS_ATOM(_33316) && IS_SEQUENCE(47)) {
        }
        else {
            Concat((object_ptr)&_source_dir_66927, _33316, 47);
            DeRef(_33316);
            _33316 = NOVALUE;
        }
        DeRef(_33316);
...
LE: 
    ...
    RefDS(_33034);
    DeRef(_backend_name_66926);
    _backend_name_66926 = _33034;

    /** il.e:491						be = open( "/usr/bin/eub", "r" )*/
    _be_66919 = EOpen(_33320, _25841, 0);
    ...
    _be_66919 = EOpen(_33323, _25841, 0);
L12: 
    ...
    /** il.e:498				sequence ondisk_name = locate_file( backend_name,*/
    {
        ...
        concat_list[1] = 47;
        concat_list[2] = _eu_dir_66928;
        Concat_N((object_ptr)&_33325, concat_list, 3);
    }
    RefDS(_source_dir_66927);
    _1 = NewS1(2);
    _2 = (object)((s1_ptr)_1)->base;
    ((intptr_t *)_2)[1] = _33325;
    ((intptr_t *)_2)[2] = _source_dir_66927;
    _33326 = MAKE_SEQ(_1);
    _33325 = NOVALUE;
    RefDS(_backend_name_66926);
    RefDS(_21928);
    _0 = _ondisk_name_66991;
    _ondisk_name_66991 = _16locate_file(_backend_name_66926, _33326, _21928);
    DeRef(_0);
    _33326 = NOVALUE;
    ...
    if (_backend_name_66926 == _ondisk_name_66991)
    _33328 = 1;
    else if (IS_ATOM_INT(_backend_name_66926) && IS_ATOM_INT(_ondisk_name_66991))
    _33328 = 0;
    else
    _33328 = (compare(_backend_name_66926, _ondisk_name_66991) == 0);
    if (_33328 != 0)
    goto L13; // [327] 338
    _33328 = NOVALUE;

    /** il.e:503						backend_name = ondisk_name*/
    RefDS(_ondisk_name_66991);
    DeRefDS(_backend_name_66926);
    _backend_name_66926 = _ondisk_name_66991;
L13: 
    DeRef(_ondisk_name_66991);
    _ondisk_name_66991 = NOVALUE;
LC: 
...
L14: 
    ...
    _2 = (object)((s1_ptr)_1)->base;
    RefDS(_backend_name_66926);
    ((intptr_t*)_2)[1] = _backend_name_66926;
    _33333 = MAKE_SEQ(_1);
    _33334 = _44GetMsgText(301, 1, _33333);
    _33333 = NOVALUE;
    _3fatal(_33334);
    _33334 = NOVALUE;
L15: 
...
L16: 
    ...
    /** il.e:524					c = getc(be)*/
    if (_be_66919 != last_r_file_no) {
        last_r_file_ptr = which_file(_be_66919, EF_READ);
        last_r_file_no = _be_66919;
    }
    if (last_r_file_ptr == xstdin) {
        if (in_from_keyb) {
            _c_66921 = getc((FILE*)xstdin);
        }
        else{
            _c_66921 = getc(last_r_file_ptr);
        }
    }
    else{
        _c_66921 = getc(last_r_file_ptr);
...
L18: 
    ...
    /** il.e:585			puts(out, '\n' & IL_START)*/
    Prepend(&_33341, _37IL_START_15513, 10);
    EPuts(_out_66918, _33341); // DJP 
    DeRefDS(_33341);
    _33341 = NOVALUE;
LA: 

    /** il.e:588		OutputHeader(out)*/
    _3OutputHeader(_out_66918);

    /** il.e:590		check_place = where(out)*/
    _0 = _19where(_out_66918);
    _3check_place_66864 = _0;
    if (!IS_ATOM_INT(_3check_place_66864)) {
        _1 = (object)(DBL_PTR(_3check_place_66864)->dbl);
        DeRefDS(_3check_place_66864);
        _3check_place_66864 = _1;
    }
    ...
    _3OutputMisc(_out_66918);

    /** il.e:598		OutputSymTab(out)*/
    _3OutputSymTab(_out_66918);

    /** il.e:599		OutputSlist(out)*/
    _3OutputSlist(_out_66918);

    /** il.e:600		fcompress( out, file_include )*/
    RefDS(_36file_include_15409);
    _37fcompress(_out_66918, _36file_include_15409);

    /** il.e:601		fcompress( out, get_switches() )*/
    _33345 = _51get_switches();
    _37fcompress(_out_66918, _33345);
    _33345 = NOVALUE;

    /** il.e:602		fcompress( out, include_matrix )*/
    RefDS(_36include_matrix_15411);
    _37fcompress(_out_66918, _36include_matrix_15411);
    ...
    RefDS(_out_name_66924);
    _3store_checksum(_out_name_66924);
    ...
    _33347 = MAKE_SEQ(_1);
    _44ShowMsg(1, 248, _33347, 1);
    _33347 = NOVALUE;

    /** il.e:609			ifdef UNIX then*/

    /** il.e:610				system("chmod +x " & out_name, 2)*/
    Concat((object_ptr)&_33349, _33348, _out_name_66924);
    system_call(_33349, 2);
    DeRefDS(_33349);
    _33349 = NOVALUE;
    ...
    RefDS(_33034);
    DeRefi(_filename_67038);
    _filename_67038 = _33034;

    /** il.e:615				ifdef WINDOWS then*/

    /** il.e:622				ShowMsg(1, 246, {filename, out_name})*/
    RefDS(_out_name_66924);
    RefDS(_filename_67038);
    _1 = NewS1(2);
    _2 = (object)((s1_ptr)_1)->base;
    ((intptr_t *)_2)[1] = _filename_67038;
    ((intptr_t *)_2)[2] = _out_name_66924;
    _33351 = MAKE_SEQ(_1);
    _44ShowMsg(1, 246, _33351, 1);
    _33351 = NOVALUE;
    DeRefDSi(_filename_67038);
    _filename_67038 = NOVALUE;
    goto L1B; // [593] 617
L1A: 
    ...
    Concat((object_ptr)&_out_name_66924, _25930, _out_name_66924);
