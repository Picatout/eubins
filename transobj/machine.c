...
object _9allocate(object _n_1961, object _cleanup_1962)
{
    object _iaddr_1963 = NOVALUE;
    object _eaddr_1964 = NOVALUE;
// skipping _873  name type: 0
// skipping _872  name type: 0
// skipping _871  name type: 0
    object _870 = NOVALUE; // 1966 870
    object _869 = NOVALUE; // 1965 869
    object _0, _1, _2;
    ...
    _0 = _eaddr_1964;
    _eaddr_1964 = _11prepare_block(_iaddr_1963, _n_1961, _10PAGE_READ_WRITE_300);
    DeRef(_0);
...
// block var cleanup_1962

// block var iaddr_1963
    DeRef(_iaddr_1963);
    return _eaddr_1964;
...
void _9free_pointer_array(object _pointers_array_2006)
{
    object _saved_2007 = NOVALUE;
    object _ptr_2008 = NOVALUE;
    object _peek_pointer_inlined_peek_pointer_at_40_2013 = NOVALUE;
// skipping _885  name type: 0
    ...
    Ref(_pointers_array_2006);
    DeRef(_saved_2007);
    _saved_2007 = _pointers_array_2006;
...
L2: // addr: 11 pc: 10 sub: 2004 op: 158
    ...
    if (_ptr_2008 <= 0) {
        if (_ptr_2008 == 0) {
            ...
            if (!IS_ATOM_INT(_ptr_2008) && DBL_PTR(_ptr_2008)->dbl == 0.0){
                goto L3; // [13] 52
            }
        }
    }
...
L4: // addr: 30 pc: 29 sub: 2004 op: 159
    ...
    _0 = _pointers_array_2006;
    if (IS_ATOM_INT(_pointers_array_2006)) {
        _pointers_array_2006 = _pointers_array_2006 + 4;
        if ((object)((uintptr_t)_pointers_array_2006 + (uintptr_t)HIGH_BITS) >= 0){
            _pointers_array_2006 = NewDouble((eudouble)_pointers_array_2006);
        }
    }
    else {
        _pointers_array_2006 = NewDouble(DBL_PTR(_pointers_array_2006)->dbl + (eudouble)4);
    }
    DeRef(_0);
...
L1: // addr: 39 pc: 38 sub: 2004 op: 159
    ...
    DeRef(_ptr_2008);
    if (IS_ATOM_INT(_pointers_array_2006)) {
        _ptr_2008 = (object)*(uint32_t *)_pointers_array_2006;
        if ((uintptr_t)_ptr_2008 > (uintptr_t)MAXINT){
            _ptr_2008 = NewDouble((eudouble)(uintptr_t)_ptr_2008);
        }
    }
    else {
        _ptr_2008 = (object)*(uint32_t *)(uintptr_t)(DBL_PTR(_pointers_array_2006)->dbl);
        if ((uintptr_t)_ptr_2008 > (uintptr_t)MAXINT){
            _ptr_2008 = NewDouble((eudouble)(uintptr_t)_ptr_2008);
        }
    }
...
L3: // addr: 52 pc: 51 sub: 2004 op: 159
...
// block var pointers_array_2006
    DeRef(_pointers_array_2006);

// block var saved_2007
    DeRef(_saved_2007);
...
object _9allocate_string(object _s_2125, object _cleanup_2126)
{
    object _mem_2127 = NOVALUE;
// skipping _943  name type: 0
    object _942 = NOVALUE; // 2133 942
    object _941 = NOVALUE; // 2132 941
// skipping _940  name type: 0
    object _939 = NOVALUE; // 2129 939
    object _938 = NOVALUE; // 2128 938
    object _0, _1, _2;
    ...
    if (IS_SEQUENCE(_s_2125)){
            _938 = SEQ_PTR(_s_2125)->length;
    }
    else {
        _938 = 1;
    }
    ...
    if (_mem_2127 == 0) {
        ...
        if (!IS_ATOM_INT(_mem_2127) && DBL_PTR(_mem_2127)->dbl == 0.0){
            goto L1; // [19] 54
        }
    }
    ...
    if (IS_ATOM_INT(_mem_2127)){
        poke_addr = (uint8_t *)_mem_2127;
    }
    else {
        poke_addr = (uint8_t *)(uintptr_t)(DBL_PTR(_mem_2127)->dbl);
    }
    _1 = (object)SEQ_PTR(_s_2125);
    ...
    if (IS_ATOM_INT(_mem_2127)) {
        ...
        _942 = NewDouble(DBL_PTR(_mem_2127)->dbl + (eudouble)_941);
    }
    _941 = NOVALUE;
...
L1: // addr: 54 pc: 53 sub: 2123 op: 159
...
void _9free(object _addr_2225)
{
    object _msg_inlined_crash_at_27_2234 = NOVALUE;
    object _data_inlined_crash_at_24_2233 = NOVALUE;
    object _addr_inlined_deallocate_at_64_2240 = NOVALUE;
    object _msg_inlined_crash_at_106_2245 = NOVALUE;
// skipping _984  name type: 0
    object _982 = NOVALUE; // 2242 982
    object _981 = NOVALUE; // 2238 981
    object _980 = NOVALUE; // 2237 980
    object _979 = NOVALUE; // 2231 979
    object _977 = NOVALUE; // 2229 977
    object _976 = NOVALUE; // 2227 976
    object _0, _1, _2;
    ...
    Ref(_addr_2225);
    _976 = _13number_array(_addr_2225);
    ...
    Ref(_addr_2225);
    _977 = _13ascii_string(_addr_2225);
    ...
    Ref(_addr_2225);
    ((intptr_t*)_2)[1] = _addr_2225;
    _979 = MAKE_SEQ(_1);
    // SubProg free pc: 25 op: ASSIGN (18)
    DeRef(_data_inlined_crash_at_24_2233);
    _data_inlined_crash_at_24_2233 = _979;
    _979 = NOVALUE;
    // SubProg free pc: 28 op: STARTLINE (58)

    /** error.e:51		msg = sprintf(fmt, data)*/
    // SubProg free pc: 30 op: SPRINTF (53)
    DeRefi(_msg_inlined_crash_at_27_2234);
    _msg_inlined_crash_at_27_2234 = EPrintf(-9999999, _978, _data_inlined_crash_at_24_2233);
    // SubProg free pc: 34 op: STARTLINE (58)

    /** error.e:52		machine_proc(M_CRASH, msg)*/
    // SubProg free pc: 36 op: MACHINE_PROC (112)
    machine(67, _msg_inlined_crash_at_27_2234);
...
L3: // addr: 44 pc: 43 sub: 2223 op: 159
    // SubProg free pc: 44 op: EXIT_BLOCK (206)

// Exiting block BLOCK: EXIT_BLOCK-Inline-crash from free @ 24

// block var data_inlined_crash_at_24_2233
    DeRef(_data_inlined_crash_at_24_2233);
    _data_inlined_crash_at_24_2233 = NOVALUE;

// block var msg_inlined_crash_at_27_2234
    DeRefi(_msg_inlined_crash_at_27_2234);
    _msg_inlined_crash_at_27_2234 = NOVALUE;
    // SubProg free pc: 46 op: NOP1 (159)
L2: // addr: 47 pc: 46 sub: 2223 op: 159
    // SubProg free pc: 47 op: STARTLINE (58)

    /** machine.e:2313			for i = 1 to length(addr) do*/
    // SubProg free pc: 49 op: LENGTH (42)
    if (IS_SEQUENCE(_addr_2225)){
            _980 = SEQ_PTR(_addr_2225)->length;
    }
    else {
        _980 = 1;
    }
    // SubProg free pc: 52 op: FOR_I (125)
    {
        object _i_2236;
        _i_2236 = 1;
L4: // addr: 59 pc: 52 sub: 2223 op: 125
        if (_i_2236 > _980){
            goto L5; // [52] 89
        }
        ...
        _2 = (object)SEQ_PTR(_addr_2225);
        _981 = (object)*(((s1_ptr)_2)->base + _i_2236);
        // SubProg free pc: 65 op: ASSIGN (18)
        Ref(_981);
        DeRef(_addr_inlined_deallocate_at_64_2240);
        _addr_inlined_deallocate_at_64_2240 = _981;
        _981 = NOVALUE;
        ...
        machine(17, _addr_inlined_deallocate_at_64_2240);
...
L6: // addr: 80 pc: 79 sub: 2223 op: 159
        // SubProg free pc: 80 op: EXIT_BLOCK (206)

// Exiting block BLOCK: EXIT_BLOCK-Inline-deallocate from free @ 64

// block var addr_inlined_deallocate_at_64_2240
        DeRef(_addr_inlined_deallocate_at_64_2240);
        _addr_inlined_deallocate_at_64_2240 = NOVALUE;
        ...
        _i_2236 = _i_2236 + 1;
        goto L4; // [84] 59
L5: // addr: 89 pc: 84 sub: 2223 op: 54
        ;
    }
...
L1: // addr: 97 pc: 96 sub: 2223 op: 159
    ...
    DeRefi(_msg_inlined_crash_at_106_2245);
    _msg_inlined_crash_at_106_2245 = EPrintf(-9999999, _983, _5);
    // SubProg free pc: 113 op: STARTLINE (58)

    /** error.e:52		machine_proc(M_CRASH, msg)*/
    // SubProg free pc: 115 op: MACHINE_PROC (112)
    machine(67, _msg_inlined_crash_at_106_2245);
...
LA: // addr: 139 pc: 138 sub: 2223 op: 159
...
LB: // addr: 153 pc: 152 sub: 2223 op: 159
