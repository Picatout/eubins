...
// skipping _22  name type: 0
    ...
    if (_2check_platform_rid_160 == -1)
    goto L1; // [5] 17
    // SubProg CheckPlatform pc: 9 op: STARTLINE (58)

    /** mode.e:55			call_proc( check_platform_rid, {} )*/
    // SubProg CheckPlatform pc: 11 op: GLOBAL_INIT_CHECK (109)
    // SubProg CheckPlatform pc: 13 op: CALL_PROC (136)
    _0 = (object)_00[_2check_platform_rid_160].addr;
    (*(intptr_t (*)())_0)(
                         );
    // SubProg CheckPlatform pc: 16 op: NOP1 (159)
L1: // addr: 17 pc: 16 sub: 194 op: 159
...
void _2set_extract_options(object _rid_213)
{
    ...
    _0 = 0; _1 = 1; if( _1 ) _2 = 0;
    // SubProg set_extract_options pc: 1 op: INTEGER_CHECK (96)
    // SubProg set_extract_options pc: 3 op: STARTLINE (58)

    /** mode.e:84		extract_options_rid = rid*/
    // SubProg set_extract_options pc: 5 op: ASSIGN_I (113)
    _2extract_options_rid_157 = _rid_213;
    // SubProg set_extract_options pc: 8 op: STARTLINE (58)

    /** mode.e:85	end procedure*/
    // SubProg set_extract_options pc: 10 op: RETURNP (29)

// Exiting block BLOCK: set_extract_options

// block var rid_213
    return;
    // SubProg set_extract_options pc: 13 op: BADRETURNF (43)
    ;
}
