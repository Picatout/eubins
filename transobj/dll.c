...
object _12open_dll(object _file_name_956)
{
    object _fh_966 = NOVALUE;
// skipping _373  name type: 0
    object _372 = NOVALUE; // 970 372
// skipping _371  name type: 0
    object _370 = NOVALUE; // 967 370
    object _369 = NOVALUE; // 965 369
    object _368 = NOVALUE; // 962 368
    object _367 = NOVALUE; // 961 367
    object _366 = NOVALUE; // 960 366
    object _365 = NOVALUE; // 959 365
    object _364 = NOVALUE; // 958 364
    object _0, _1, _2;
    ...
    if (IS_SEQUENCE(_file_name_956)){
            _364 = SEQ_PTR(_file_name_956)->length;
    }
    else {
        _364 = 1;
    }
    ...
    RefDS(_file_name_956);
    _367 = _13string(_file_name_956);
...
L1: // addr: 35 pc: 34 sub: 954 op: 159
    ...
    // SubProg open_dll pc: 40 op: FOR_I (125)
    {
        object _idx_964;
        _idx_964 = 1;
L2: // addr: 47 pc: 40 sub: 954 op: 125
        if (_idx_964 > _369){
            goto L3; // [40] 82
        }
        ...
        _2 = (object)SEQ_PTR(_file_name_956);
        _370 = (object)*(((s1_ptr)_2)->base + _idx_964);
        // SubProg open_dll pc: 53 op: MACHINE_FUNC (111)
        DeRef(_fh_966);
        _fh_966 = machine(50, _370);
        _370 = NOVALUE;
        // SubProg open_dll pc: 57 op: STARTLINE (58)

        /** dll.e:190			if not fh = 0 then*/
        // SubProg open_dll pc: 59 op: NOT (7)
        if (IS_ATOM_INT(_fh_966)) {
            _372 = (_fh_966 == 0);
        }
        else {
            _372 = unary_op(NOT, _fh_966);
        }
...
L4: // addr: 73 pc: 72 sub: 954 op: 159
...
// block var fh_966
        ...
        _idx_964 = _idx_964 + 1;
        goto L2; // [77] 47
L3: // addr: 82 pc: 77 sub: 954 op: 54
        ;
    }
...
object _12define_c_func(object _lib_996, object _routine_name_997, object _arg_types_998, object _return_type_999)
{
    object _safe_address_inlined_safe_address_at_11_1004 = NOVALUE;
    object _msg_inlined_crash_at_26_1007 = NOVALUE;
    object _386 = NOVALUE; // 1009 386
    object _385 = NOVALUE; // 1008 385
    object _384 = NOVALUE; // 1005 384
    object _383 = NOVALUE; // 1002 383
    object _382 = NOVALUE; // 1001 382
    object _0, _1, _2;
    ...
    _safe_address_inlined_safe_address_at_11_1004 = 1;
    ...
    DeRefi(_msg_inlined_crash_at_26_1007);
    _msg_inlined_crash_at_26_1007 = EPrintf(-9999999, _379, _5);
    ...
    machine(67, _msg_inlined_crash_at_26_1007);
...
L1: // addr: 46 pc: 45 sub: 994 op: 159
    ...
    Ref(_lib_996);
    ((intptr_t*)_2)[1] = _lib_996;
    Ref(_routine_name_997);
    ((intptr_t*)_2)[2] = _routine_name_997;
    RefDS(_arg_types_998);
    ((intptr_t*)_2)[3] = _arg_types_998;
    ((intptr_t*)_2)[4] = _return_type_999;
    _385 = MAKE_SEQ(_1);
...
// block var routine_name_997
    DeRefi(_routine_name_997);

// block var arg_types_998
    DeRefDSi(_arg_types_998);

// block var return_type_999
    return _386;
